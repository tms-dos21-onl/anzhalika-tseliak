...
>$()  -подстановка/расширение команды или выполнение команды внутри другой команды
...
Второй вариант - с помощью команды rsync,которая используется для перемещения файлов между системами,локально и также дает возможность назначать права на новые файлы.
